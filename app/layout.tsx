...
export const metadata: Metadata = {
  ...
  description: "Discover quality products with ShopEase",
  generator: "v0.app",
  icons: {
    icon: [
      {
          ...
          <div className="bg-primary text-primary-foreground">
            <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between text-sm">
              ...
              <div className="flex items-center gap-6">
                <span>KIT-CATALOG</span>
                <span>Office: 0422 253 2325</span>
              </div>
            </div>
          </div>
              ...
              <div className="hidden md:flex items-center gap-8">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-1 w-48 bg-card border border-border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                    <Link href="/about" className="block px-4 py-3 text-foreground hover:bg-secondary transition">
                      About Us
                    </Link>
                    <Link href="/certifications" className="block px-4 py-3 text-foreground hover:bg-secondary transition">
                      Certification and Awards
                    </Link>
                    <Link href="/network" className="block px-4 py-3 text-foreground hover:bg-secondary transition">
                      Network
                    </Link>
                  </div>
                </div>
